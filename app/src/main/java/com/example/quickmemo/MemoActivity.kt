...
class MemoActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.btnSave).setOnClickListener {
            ...
            if (text.isNotEmpty()) Toast.makeText(this, "Memo saved: $text", Toast.LENGTH_SHORT).show()
            finish()
        }
        findViewById<Button>(R.id.btnDiscard).setOnClickListener {
            Toast.makeText(this, "Memo discarded", Toast.LENGTH_SHORT).show(); finish()
        }
        findViewById<ImageButton>(R.id.btnNewMemo).setOnClickListener {
            memoInput.text.clear(); memoInput.requestFocus()
